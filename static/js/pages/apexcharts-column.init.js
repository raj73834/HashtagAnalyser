...
function updateQuarterChart(t, e) {
    ...
    if (t.w.globals.selectedDataPoints[0]) {
        ...
        return 0 === a.length && (a = [{ data: [] }]), ApexCharts.exec(e, "updateOptions", { series: a, colors: r, fill: { colors: r } });
    }
}
var options = {
    ...
    chart: {
        ...
        events: {
            dataPointSelection: function (t, e, a) {
                ...
                1 === a.selectedDataPoints[0].length && (r.classList.contains("active") || (o.classList.add("chart-quarter-activated"), r.classList.add("active"))),
                    updateQuarterChart(e, "barQuarter"),
                    0 === a.selectedDataPoints[0].length && (o.classList.remove("chart-quarter-activated"), r.classList.remove("active"));
            },
            updated: function (t) {
