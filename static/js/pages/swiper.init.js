var swiper = new Swiper(".default-swiper", { loop: !0, autoplay: { delay: 2500, disableOnInteraction: !1 } }),
    ...
    swiper = new Swiper(".pagination-dynamic-swiper", { loop: !0, autoplay: { delay: 2500, disableOnInteraction: !1 }, pagination: { clickable: true, el: ".swiper-pagination", dynamicBullets: !0 } }),
    ...
    swiper = new Swiper(".mousewheel-control-swiper", { loop: !0, direction: "vertical", mousewheel: !0, autoplay: { delay: 2500, disableOnInteraction: !1 }, pagination: { el: ".swiper-pagination", clickable: true } }),
    swiper = new Swiper(".effect-fade-swiper", { loop: !0, effect: "fade", autoplay: { delay: 2500, disableOnInteraction: !1 }, pagination: { el: ".swiper-pagination", clickable: true } }),
    ...
    swiper = new Swiper(".effect-flip-swiper", { loop: !0, effect: "flip", grabCursor: !0, autoplay: { delay: 2500, disableOnInteraction: !1 }, pagination: { el: ".swiper-pagination", clickable: true } }),
