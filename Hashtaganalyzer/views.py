...
def index(request):
    ...
    'new_list': new_list,'lang':lang,'freq':freq, 'user_name':user_name[:15],'user_count':user_count[:15],'one_user_data':user_detail_dic,
    ...
    'hash_name_count':zip(hash_name,hash_count,color_arr)}
